...
def __set_chromosome_converter(goal_keys: list[str], stock_keys: list[str]):
...
def parse(file) -> tuple[list[Process], Chromosome, tuple[int]]:
    ...
    __set_chromosome_converter(goal, stock)
